# v0.9.3-rc1 Release Candidate — 发布前人工验收清单

> 定位：**v0.9.3 Stability Release（稳定性修复版）· RC 候选版**
>
...
- 安装包 `InkSpirit-Setup-0.9.3-rc1.exe` 在干净机器上安装时不被拦截（或拦截时有明确引导）
...
```
v0.9.2（或 v0.9.3-rc1）→ 安装 v0.9.3 Stable
```
