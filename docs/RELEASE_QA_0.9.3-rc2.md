# v0.9.3-rc2 Release Candidate — 发布前人工验收清单
...
- 安装包 `InkSpirit-Setup-0.9.3-rc2.exe` 在干净机器上安装时不被拦截（或拦截时有明确引导）
...
```
v0.9.1（或 v0.9.3-rc2）→ 安装 v0.9.2 Stable
```
